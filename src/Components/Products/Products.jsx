    ...
    return (
        <div className='max-w-[1200px] text-center px-4 mx-auto mt-20 mb-20'>
            ...
            <div className="flex items-center justify-center border border-gray-200 rounded-full p-1 w-fit mx-auto mb-11">
             ...
             {selectedType === "available" ? <AllProducts products={products} setCount={setCount} count={count} setSelectedProducts={setSelectedProducts} selectedProducts={selectedProducts} /> : 
             <SelectedProduct selectedProducts={selectedProducts} setSelectedProducts={setSelectedProducts} setCount={setCount} count={count}/>}
        </div>
    );
};
